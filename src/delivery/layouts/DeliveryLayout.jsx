...
import DeliveryProfileDropdown from "../components/DeliveryProfileDropdown";
...
export default function DeliveryLayout({ children, title }) {
  ...
  useEffect(() => {
    document.title = title ? `${title} — Selloship Delivery` : "Selloship Delivery";
  }, [title]);
  ...
  const navigation = [
    ...
    { name: "Notifications", href: "/delivery/notifications", icon: Bell },
  ];
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{getStoreName()} • Delivery</p>
                </div>
              </div>
              <button
                onClick={() => setSidebarOpen(false)}
        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-4">
              ...
              <span className="px-2.5 py-1 bg-slate-800/10 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-full">Delivery Staff</span>
            </div>

            <div className="flex items-center gap-4">
              <DeliveryNotificationBell />
              <DeliveryProfileDropdown />
            </div>
          </div>
        </header>
