...
export default function DeliveryLogin() {
  ...
  useEffect(() => { document.title = "Delivery Login — Selloship"; }, []);
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (querySnapshot.empty) {
        setError("Invalid delivery credentials");
        setLoading(false);
        return;
      }
      ...
      if (deliveryData.password !== password) {
        setError("Invalid delivery credentials");
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#0a66c2]/15 rounded-full blur-3xl"></div>
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-slate-800 rounded-2xl mb-4 shadow-lg shadow-slate-500/30">
              <Truck className="text-white" size={32} />
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Delivery Login</h1>
            <p className="text-gray-500">Selloship Delivery Partner Portal</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="delivery@selloship.com"
                  required
          ...
          <div className="mt-6 text-center space-y-3">
            <a href="/delivery/forgot-password" className="text-sm text-[#0a66c2] hover:underline font-medium block">
              Forgot Password?
            </a>
